...
export const createMediaSelectionDialog = () => {
  ...
  const openScreen = async (enableMicrophone?: boolean) => {
            ...
            <Show
              ...
              fallback={
                <Show when={localStream()}>
                  ...
                  <Badge
                    variant="secondary"
                    class="absolute right-2 top-2 bg-black/50 text-white
                      hover:bg-black/80"
                  >
                    {t(
            ...
            >
              {(stream) => (
                <>
                  ...
                  <Badge
                    variant="secondary"
                    class="absolute right-2 top-2 gap-1 bg-black/50 text-white
                      hover:bg-black/80"
                  >
                    {t(
          ...
          >
            ...
            >
              <label class="flex flex-col gap-1">
                <Label>
                  {t(
                    "common.media_selection_dialog.microphone",
                  )}
                </Label>
                ...
                fallback={
                  <Show when={canGetDisplayMedia()}>
                    <Button
                      size="sm"
                      onClick={() =>
                        openScreen(enableScreenMicrophone())
                      }
                      class="w-full"
                    >
                      {t(
          ...
          >
            ...
            >
              <label class="flex flex-col gap-1">
                <Label>
                  {t(
                    "common.media_selection_dialog.camera",
                  )}
                </Label>
                <Select<MediaDeviceInfoType>
                ...
                <Show
                  ...
                  fallback={
                    <Show when={canGetUserMedia()}>
                      ...
                      >
                        {t(
                          "common.media_selection_dialog.open_camera",
                        )}
                      </Button>
                    </Show>
                  }
